                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input value={{ $job->vacancy }} type="number" min="1" placeholder="Vacancy"
                            ...
                            <div class="mb-4">
                                ...
                                <input value={{ $job->keywords }} type="text" placeholder="keywords" id="keywords"
...
@section('customJs')
    <script type="text/javascript">
        $("#editJobForm").submit(function(e) {
            e.preventDefault();
            $("button[type='submit']").prop('dasabled', true)
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: $("#editJobForm")
                    .serializeArray(), //array ko bhitra objects ma form ma bhako dat aprint garxa
                success: function(response) {
                    $("button[type='submit']").prop('dasabled', false)
                    if (response.status == true) {
                        ...
                        window.location.href = "{{ route('account.myJobs') }}" //to load the page
                    } else {
